...
type DarkProps = { dark?: boolean };

export function IOSStatusBar({
  dark = false,
  time = "9:41",
}: DarkProps & { time?: string }) {
...
export function IOSGlassPill({
  ...
  dark = false,
  style = {},
}: DarkProps & { children?: ReactNode; style?: CSSProperties }) {
  return (
    <div
      style={{
        height: 44,
...
export function IOSNavBar({
  ...
  dark = false,
  trailingIcon = true,
}: DarkProps & { title?: string; trailingIcon?: boolean }) {
...
export function IOSList({
  ...
  children,
  dark = false,
}: DarkProps & { header?: ReactNode; children?: ReactNode }) {
...
export function IOSKeyboard({ dark = false }: DarkProps) {
